...
- `logo.svg`: editable flat-color source for light surfaces.
- `logo-dark.svg`: editable flat-color source for dark surfaces.
- `icon.png`: 512 × 512 transparent marketplace/composer icon.
- `logo.png`: 1024 × 1024 transparent logo for light surfaces.
- `logo-dark.png`: 1024 × 1024 transparent logo for dark surfaces.
