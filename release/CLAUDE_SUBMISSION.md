...
- Plugin ID: `aipilot`
- Developer: JililiDD
- Repository: https://github.com/JililiDD/aipilot
- Homepage: https://github.com/JililiDD/aipilot#readme
...
- Run `claude plugin validate . --strict` with the current Claude Code release.
- Add the local marketplace and install `aipilot@aipilot` from the release tree.
