...
AI Pilot exposes the shared `skills/` directory to Codex. The Codex manifest
intentionally does not declare hooks because the Codex plugin validator rejects
unsupported manifest fields such as `hooks`.

Use AI Pilot by invoking its installed skills or by asking Codex to use AI Pilot
