...
- `candidate_rule_area`: likely target such as `AGENTS.md`, `agent-guideline.md`, `product-spec-builder`, `design-spec-builder`, `dev-plan-builder`, or `hook`.
- `status`: `pending`, `proposed`, `applied`, `discarded`, or `watch`.

## Good Signals

```json
{"timestamp":"2026-06-22T14:00:00-07:00","source":"product-spec-builder","event":"user_correction","summary":"User rejected fixed 3-5 question batches and prefers asking the smallest useful number of questions.","candidate_rule_area":"product-spec-builder","status":"applied"}
```
