...
| `agent-guideline.md` | State | Active project-specific workflow conventions and overrides; never plugin-wide defaults | User; `note-keeper` when durable intent is explicit or confirmed |
